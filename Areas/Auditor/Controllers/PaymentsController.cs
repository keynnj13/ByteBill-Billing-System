    ...
    public IActionResult Index(string? search, PaymentMethod? method, int page = 1)
    {
        ...
        var viewModel = new PaymentListViewModel
        {
            ...
            Payments = new List<PaymentItemViewModel>
            {
                ...
                new() { Id = 3, PaymentNumber = "PAY-2024-0140", InvoiceNumber = "INV-2024-0138", InvoiceId = 138, CustomerName = "Bob Martinez", CustomerInitials = "BM", Amount = 150.00m, Method = PaymentMethod.Card, PaidAt = DateTime.Now.AddDays(-1), ReceivedByName = "John Anderson", IsVoid = true },
